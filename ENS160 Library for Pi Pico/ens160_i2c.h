...
class ENS160 {
    public:
        i2c_inst_t *i2cbus;
        int i2c_address;
        ENS160(i2c_inst_t *i2c_device_bus, int i2c_device_address);
        ...
        int32_t writeRegisterRegion(uint8_t reg, uint8_t data, uint8_t length);
        ...
        int32_t readRegisterRegion(uint8_t reg, uint8_t *data, uint8_t length);
